    ...
    <div class="app-container">
      ...
      <page-tools :show-before="true">
        ...
        <template v-slot:after>
          <el-button size="mini" type="danger" @click="$router.push('/social/historicalArchiving')">历史归档</el-button>
          <el-button size="mini" type="primary" @click="$router.push(`/social/monthStatement?yearMonth=${yearMonth}`)">{{ yearMonth }}报表</el-button>
        </template>
      </page-tools>
      <!-- 筛选组件 -->
      <social-tool />
