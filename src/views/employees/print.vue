...
<script>
import { getPersonalDetail, getJobDetailById } from '@/api/employees'
...
export default {
  ...
  // 创建完毕状态
  created() {
    this.type === 'personal' ? this.getPersonalDetail() : this.getJobDetailById()
  },
  // 组件更新
  methods: {
    ...
    async getJobDetailById() {
      ...
      const jobInfo = await getJobDetailById(this.userId) // 获取个人基本信息
